...
export default function GoogleReview({ link, textColor = '#FFFFFF' }: GoogleReviewProps) {
  return (
    <Link href={link} target="_blank" className="w-full block">
      ...
      >
        <div className="bg-white rounded-full overflow-hidden p-1 w-12 h-12 flex items-center justify-center">
